<div class="content magazine_wrapper">
	<div class="container">
		<h1><?= remove_br($arr_magazine_info["name"]) ?> - Оформить подписку на журнал</h1>

		<div class="under_wrapper">
			<div class="row">	
				<div class="col-md-3">
					<img class="magazine_cover" src="/_img/magazine/<?= $arr_magazine_info["id"] ?>/cover.jpg" />
				</div>
				<div class="col-md-9">
					<?php if ($arr_magazine_info["subtitle"]) { ?><h2><?= $arr_magazine_info["subtitle"] ?></h2><?php } ?>
					<div class="magazine_properties_wrapper">
						<?php if ($arr_magazine_info["page_size"]) { ?>
							<div class="eItemProperties_line">
								...
								<div class="eItemProperties_text">
									<span class="eItemProperties_textinner"><?= $arr_magazine_info["page_size"] ?></span>
								</div>
							</div>						
						<?php } ?>
						<?php if ($arr_magazine_info["month_releases_num"]) { ?>
							<div class="eItemProperties_line">
								<div class="eItemProperties_name">
									<div class="eItemProperties_nameBackground">Количество номеров в году</div>
								</div>	
								<div class="eItemProperties_text">
									<span class="eItemProperties_textinner"><?= $arr_magazine_info["month_releases_num"]*12 ?></span>
								</div>
							</div>						
						<?php } ?>
					</div>
					<?php if ($arr_magazine_info["description"]) { ?>
						<div class="row">	
							<div class="col-md-12">
								<div class="magazine__description">
									<?= $arr_magazine_info["description"] ?>
								</div>
							</div>		
						</div>
					<?php } ?>
			...
			<form id="form_podpiska" action="/subscribe/" method="post">
				...
				<input type="hidden" name="magazine_id" value="<?= $arr_magazine_info["id"] ?>" />
				<input type="hidden" name="monthes" id="form_monthes" value="12" />
				<input type="hidden" name="post_index" value="<?= $arr_magazine_info["post_index"] ?>" />
				...
				<input type="hidden" name="price" id="form_price" value="<?= $arr_magazine_info["price_12_monthes"] ?>" />
				<input type="hidden" name="price_discounted" id="form_price_discounted" value="" />				

				<input type="hidden" name="price_6_monthes" id="form_price_6_monthes" value="<?= $arr_magazine_info["price_6_monthes"] ?>" />
				<input type="hidden" name="price_12_monthes" id="form_price_12_monthes" value="<?= $arr_magazine_info["price_12_monthes"] ?>" />
				...
				<div class="subscribe_type_wrapper">
					...
					<div class="row radio_wrapper">
						<div class="col-xs-6">
							<input type="radio" name="monthes" id="radio_monthes6" value="6" class="landing-radio" price="<?= $arr_magazine_info["price_6_monthes"] ?>" price_discounted="" monthes="6" />
							<label for="radio_monthes6">
								<span class="landing-radio-deco"></span>
								<span class="landing-radio-text">
									6 месяцев<br />
									(<?= 6*$arr_magazine_info["month_releases_num"] ?> номеров)<br />
								</span>
							</label>
						</div>
						<div class="col-xs-6">
							<input type="radio" name="monthes" id="radio_monthes12" value="12" class="landing-radio" checked="checked" price="<?= $arr_magazine_info["price_12_monthes"] ?>" price_discounted="" monthes="12" />
							<label for="radio_monthes12">
								<span class="landing-radio-deco"></span>
								<span class="landing-radio-text">
									12 месяцев<br />
									(<?= 12*$arr_magazine_info["month_releases_num"] ?> номеров)<br />
								</span>
							</label>
						</div>
					</div>
				...
				<div class="promocode_wrapper">
					...
					<div class="input-group">
						<input type="text" name="promocode" id="promocode" class="sm-form-control" value="" placeholder="Введите промокод" />
						<span class="input-group-btn">
							<button class="button button-3d" type="button" id="discount_button" action="/ajax/" magazine_id="<?= $arr_magazine_info["id"] ?>" error_container="error_promocode" success_container="success_promocode">Применить</button>
						</span>
					</div>
					<div class="help-block-wrapper">
						<div class="help-block centred" id="error_promocode"></div>
						<div class="success-block centred" id="success_promocode"></div>
					</div>
				</div>
				...
				<div class="final_price_wrapper">
					...
					<p class="price">
						<span id="price">
							<span class="sum"><?= $arr_magazine_info["price_12_monthes"] ?></span>
				...
				<div class="form-wrapper">
					...
					<div class="form-group">
						...
						<div class="col-md-8" id="fio-wrapper">
							<input type="text" id="fio" name="fio" class="form-control" value="<?php echo get_cookie_value('fio'); ?>" required="required" />
					...
					<div class="form-group">
						...
						<div class="col-md-8" id="email-wrapper">
							<input type="text" id="email" name="email" class="form-control" value="<?php echo get_cookie_value('email'); ?>" required="required" />
					...
					<div class="form-group">
						...
						<div class="col-md-8" id="tel-wrapper">
							<input type="text" id="tel" name="tel" class="form-control" value="<?php echo get_cookie_value('tel'); ?>" required="required" />
					...
					<div class="form-group">
						...
						<div class="col-md-8" id="region-wrapper">
							<input type="text" id="region" name="region" class="form-control" value="<?php echo get_cookie_value('region'); ?>" required="required" />
					...
					<div class="form-group">
						...
						<div class="col-md-8" id="city-wrapper">
							<input type="text" id="city" name="city" class="form-control" value="<?php echo get_cookie_value('city'); ?>" required="required" />
					...
					<div class="form-group">
						...
						<div class="col-md-8" id="street-wrapper">
							<input type="text" id="street" name="street" class="form-control" value="<?php echo get_cookie_value('street'); ?>" required="required" />
					...
					<div class="form-group">
						...
						<div class="col-md-8" id="house-wrapper">
							<input type="text" id="house" name="house" class="form-control" value="<?php echo get_cookie_value('house'); ?>" required="required" />
					...
					<div class="form-group">
						...
						<div class="col-md-8" id="flat-wrapper">
							<input type="text" id="flat" name="flat" class="form-control" value="<?php echo get_cookie_value('flat'); ?>" />
					...
					<div class="form-group">
						...
						<div class="col-md-8" id="zip-wrapper">
							<input type="text" id="zip" name="zip" class="form-control" value="<?php echo get_cookie_value('zip'); ?>" required="required" />
					...
					<input type="hidden" name="normalized_region" id="normalized_region" value="" />
					<input type="hidden" name="normalized_district" id="normalized_district" value="" />
					<input type="hidden" name="normalized_city" id="normalized_city" value="" />
					<input type="hidden" name="normalized_street" id="normalized_street" value="" />
					<input type="hidden" name="normalized_house" id="normalized_house" value="" />
					<input type="hidden" name="normalized_flat" id="normalized_flat" value="" />

					<input type="hidden" name="normalized_city_type" id="normalized_city_type" value="" />
					<input type="hidden" name="normalized_street_type" id="normalized_street_type" value="" />
					<input type="hidden" name="normalized_house_type" id="normalized_house_type" value="" />
					<input type="hidden" name="korpus" id="korpus" value="" />
					<input type="hidden" name="normalized_korpus_type" id="normalized_korpus_type" value="" />

					<div class="submit_wrapper">
						<button class="button button-3d" type="button" value="submit" id="submit_button">Оплатить</button>
					</div>
				</div>
			</form>
...
<div class="bottom_line_subscribe">
	Подписаться на год - <?= $arr_magazine_info["price_12_monthes"] ?>  руб.<!--span class="icon-rouble-big">i</span-->
</div>
<script>
